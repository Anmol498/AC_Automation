...
if (process.env.NODE_ENV === 'development') {
    console.log(`Initialising database pool with host: ${dbConfig.host}, user: ${dbConfig.user}, database: ${dbConfig.database}, port: ${dbConfig.port}`);
} else {
    console.log("Initialising database pool...");
}
